...
if __name__=='__main__':
    ...
    train_data_path = '../NCaltech-101/event_frames_ts/training/'
    test_data_path  = '../NCaltech-101/event_frames_ts/testing/'
    val_data_path   = '../NCaltech-101/event_frames_ts/validation/'
