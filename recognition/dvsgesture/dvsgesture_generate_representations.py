...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-dir", type=str, default=f"{INPUT_ROOT}/dvsgesture/", help="Path to input dir")
    parser.add_argument("--output-dir", type=str, default=f"{OUTPUT_ROOT}/dvsgesture/", help="Path to output dir")
